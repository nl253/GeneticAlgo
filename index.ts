...
const getNumOpt = (percentageOf: number | undefined, o: NumOpt): NumOptResolved => {
...
const fmtTable = (heading: string, obj: object = {}, doUnderline = false, doNL = true, log: (...msg: any[]) => any = console.log): void => {
...
export class GeneticAlgorithm extends EventEmitter {
  ...
  public constructor(fitness: FitnessFunct | FitnessFunct[], nGenes: number, dtype: Dtype = 'f64', opts: UserOpts = {}) {
    ...
    if (opts.randGeneVal === undefined) {
      ...
      this.randGeneVal = (): number => boundLower + randRange * Math.random();
